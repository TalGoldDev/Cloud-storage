...
export const Features = () => {
  return (
    <div id="features" className="mt-16 text-white md:text-black md:mt-96 flex">
      <div className="m-auto flex flex-col rounded-2xl bg-white bg-opacity-60 items-center p-3 2xl:border-2 2xl:bg-opacity-90">
        <img src="/star.png" className="hidden md:block w-12 h-12"></img>
        <h2 className="text-4xl font-bold  mt-4">Our Features</h2>
        <div
          id="feature-list"
          className="mt-6 md:pl-4 md:pr-4 md:space-x-6 md:space-y-6 flex flex-col md:flex-row flex-wrap justify-center"
        >
          <div className="flex flex-col items-center md:items-start md:pl-6 pt-6">
            <svg
              className="w-16 h-16"
